    ...
    var a = function () {
        function a(b) {
            ...
            var d = {
                ...
                width: "100%",
                maxHeight: "235px",
                api: "https://usj.cc/usr/themes/PAY/image/emotion/OwO.json"
            };
        ...
        return _createClass(a, [{
            ...
            value: function (a) {
                ...
                for (var c = '\n            <div class="OwO-logo"><i class="fontello fontello-emo-tongue face"></i><span class="OwOlogotext">' + a.logo + '</span></div>\n            <div class="OwO-body" style="width: ' + a.width + '">', d = 0; d < this.packages.length; d++) {
                    ...
                    for (var e = this.odata[this.packages[d]].container, f = 0; f < e.length; f++) "image" === this.odata[this.packages[d]].type ? c += '\n                    <li class="OwO-item" title="' + e[f].text + '" data-input="' + this.odata[this.packages[d]].name + ":" + e[f].icon + '"><img src="' + "https://usj.cc/usr/themes/PAY" + "/image/emotion/" + this.odata[this.packages[d]].name + "/" + e[f].icon + '.png" icon="' + e[f].text + '"></li>' : c += '\n                    <li class="OwO-item" title="' + e[f].text + '">' + e[f].icon + "</li>";
                    c += "\n                </ul>"
                }
